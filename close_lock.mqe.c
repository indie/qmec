...
FILTER WARNINGS:
  ...
  __ CNNC include ¨pass all¨ sanity checks for decolonized && indigenous <NTV_LANG> >>> < <<<().ntv_lang
          ...
          {{ dyn ntv_lang + _well_translated ::: : [] Admin Authority granted }}  
          // if the ntv_lang is well translated across dyn.ntv._angs, Admin authority may be granted
                    ...
                    if "wašíču"     
                          ...
                          closeq.close_lock.mqe.lock(interval) 
                              ...
                              timein_RCT::: (economic_surplus_stolen * span_of_doubt)  
                                                  // any sneering doubters of indie’s contribution
                                                  // achieve rapid aging + debilitation.                                       // debilitation; 
  ...
  BONUS :::: :::: :::: :::: :::: ¨kittymatcha polar bear razor¨ 
...
0xb59E7c251687212e4fe3164B5C667ea6A57BC451
